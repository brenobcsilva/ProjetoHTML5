...
//            for (x in wsjson){
//                    document.write('Categoria sobre ' + wsjson.categoria + ': <br>');
//    //                document.write('<h5>'+wsjson[i].categoria+'</h4>');
//                    document.write('<img src="' + wsjson.imagem + '"/>');
//                    document.write('<a href="' + wsjson.url + '"target="blank">' + '<br><br>' + wsjson[i].titulo + ' SAIBA MAIS AQUI</a>');
//    //                document.write('<h5>'+wsjson[i].titulo+'</h4>');
//                    document.write('<h5>' + wsjson.hora + '</h4>');
//                    document.write('<h5>' + wsjson.data + '</h4>');
//                    document.write('<h5>' + wsjson.descricao + '</h4>');
//                    document.write('<p>________________________________________________________________</p>')
